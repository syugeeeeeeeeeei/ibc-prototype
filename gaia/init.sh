...
if [ ! -f /data/gaia-1/config/genesis.json ]; then
  ...
  sed -i 's/minimum-gas-prices = ""/minimum-gas-prices = "0.01uatom"/g' /data/gaia-1/config/app.toml
...
if [ ! -f /data/gaia-2/config/genesis.json ]; then
  ...
  sed -i 's/minimum-gas-prices = ""/minimum-gas-prices = "0.01uatom"/g' /data/gaia-2/config/app.toml
